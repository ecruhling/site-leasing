 ...
 */
$site_leasing_gotten_options = [];

global $site_leasing_gotten_options;
...
class Site_Leasing_Options {
	...
	public $defaultOptionValues = [
		...
		// 'single_floorplan_schedule_a_tour_url' => 'http://default',
		// 'single_floorplan_request_more_info_url' => 'http://default',
	];
	...
	public function getOption( $optionName, $default = null ) {
		...
		if ( isset( $site_leasing_gotten_options[ $prefixedOptionName ] ) ) {
			$retVal = $site_leasing_gotten_options[ $prefixedOptionName ];
		} else {
			$retVal                                             = get_option( $prefixedOptionName );
			$site_leasing_gotten_options[ $prefixedOptionName ] = $retVal;
		}
	...
	public function addOption( $optionName, $value ) {
		...
		$site_leasing_gotten_options[ $prefixedOptionName ] = $value;
