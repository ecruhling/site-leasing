...
if( ! class_exists('Site_Leasing_Ajax_Check_Screen') ) :

class Site_Leasing_Ajax_Check_Screen extends Site_Leasing_AJAX {
...
acf_new_instance('Site_Leasing_Ajax_Check_Screen');
